...
| SCR-13 | Photo & Video Showcase | `[LIVE, awaiting webhook registration + env vars — see PLAN-9]` Jotform embed (form `261963488177069`, from DS-47/`JOTFORM_SHOWCASE_FORM_ID`) + "Email Me This Link" button (EP-25); marketing copy covers the $25/10-credit reward and video requirements (≥20s, different angles, people using the frame) | EP-16 (showcase branch), EP-25, DS-47…53 |
