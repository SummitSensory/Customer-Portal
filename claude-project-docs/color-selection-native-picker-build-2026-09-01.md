...
Everything above lives on `claude/color-selection-redesign`, committed locally, **not pushed, not merged to `staging` or `main`**. 64 tests passing, full production build clean. Not deployed anywhere.
