...
// only the exact keys/fields this order's productType has, so a malformed
// or oversized payload can never reach storage regardless of what a
...
describe('sanitizeSelections', () => {
  ...
  it('returns an empty object for an unsupported productType', () => {
