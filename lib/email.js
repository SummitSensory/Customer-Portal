...
function shell(content, { preheader = '' } = {}) {
  const logoBlock = `<table cellpadding="0" cellspacing="0" border="0">
    <tr>
      <td valign="middle" style="padding-right:12px">
        ${LOGO_URL
          ? `<img src="${LOGO_URL}" alt="Summit Sensory Gym logo" width="44" height="44" style="display:block;width:44px;height:44px;border-radius:8px;object-fit:contain" />`
          : `<div style="width:44px;height:44px;background:${C.moss};border-radius:8px;text-align:center;line-height:44px;font-size:20px;font-weight:800;color:#fff">S</div>`
        }
      </td>
      <td valign="middle">
        <span style="font-family:Arial,sans-serif;font-size:17px;font-weight:800;color:${C.ink};letter-spacing:-.3px;white-space:nowrap">Summit Sensory Gym</span>
      </td>
    </tr>
  </table>`;
