...
export const COLS = {
  ...
  colorFrameType:       process.env.MONDAY_COL_COLOR_FRAME_TYPE      || 'color_mm7c461v', // "Product Type" (Adventure/Soar/Flex) — informational only, does NOT gate any requirement
  colorAdventureMat:    process.env.MONDAY_COL_COLOR_ADVENTURE_MAT   || 'color_mm7cv6j5', // "Adventure-Mat Color" (vinyl; includes Zip Line per Bryan 2026-09-21)
  colorClimbingWall:    process.env.MONDAY_COL_COLOR_CLIMBING_WALL   || 'color_mm7c6q9z', // "Climbing Wall-Color" (paint — Cardinal/Prismatic)
  colorClimbingWallMat: process.env.MONDAY_COL_COLOR_CLIMBING_WALL_MAT || 'color_mm7ctqey', // "Climbing Wall-Mat Color" (vinyl)
  colorWallPaddingMat:  process.env.MONDAY_COL_COLOR_WALL_PADDING_MAT || 'color_mm7ct8yn', // "Wall Padding-Mat Color" (vinyl, its own separate item per Bryan 2026-09-21)
  colorSlide:           process.env.MONDAY_COL_COLOR_SLIDE           || 'color_mm7cj96b', // "Slide-Color" (plastic — Blue/Green/Gray, sourced 2026-09-21)
  colorSoarMat:         process.env.MONDAY_COL_COLOR_SOAR_MAT        || 'color_mm7c2yt7', // "Soar-Mat Color" (vinyl)
  colorFlexMat:         process.env.MONDAY_COL_COLOR_FLEX_MAT        || 'color_mm7cdjgq', // "Flex-Mat Color" (vinyl)
  colorPalisadesMat:    process.env.MONDAY_COL_COLOR_PALISADES_MAT   || 'color_mm7cqn6f', // "Palisades-Mat Color" (vinyl)
  colorBallPitMat:      process.env.MONDAY_COL_COLOR_BALL_PIT_MAT    || 'color_mm7c5ssq', // "Ball Pit-Mat Color" (vinyl)
  colorBallPitBalls:    process.env.MONDAY_COL_COLOR_BALL_PIT_BALLS  || 'color_mm7cmwap', // "Ball Pit-Ball Colors" (vinyl — no quantity-allocator UI yet; gate exists, not shown to customers)
  colorFoundationMat:   process.env.MONDAY_COL_COLOR_FOUNDATION_MAT  || 'color_mm7c5nq2', // "Foundation System-Mat Color" (two-tone foam tile — Black/Gray, Red/Blue, Green/Gray, sourced 2026-09-22)
};
...
async function parseOrderItem(item) {
  ...
  return {
    ...
    colorFrameType: get('colorFrameType'),
    colorGates: {
      adventureMat: get('colorAdventureMat'),
      climbingWallColor: get('colorClimbingWall'),
      climbingWallMat: get('colorClimbingWallMat'),
      wallPaddingMat: get('colorWallPaddingMat'),
      slideColor: get('colorSlide'),
      soarMat: get('colorSoarMat'),
      flexMat: get('colorFlexMat'),
      palisadesMat: get('colorPalisadesMat'),
      ballPitMat: get('colorBallPitMat'),
      ballPitBalls: get('colorBallPitBalls'),
      foundationMat: get('colorFoundationMat'),
    },
