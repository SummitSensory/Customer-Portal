...
export const DELIVERY_COLS = {
  ...
  commMethods:           process.env.MONDAY_DEL_COL_COMM_METHODS     || 'text_mm57t33w',   // "Preferred Communication Method"
  mobileForText:         process.env.MONDAY_DEL_COL_MOBILE           || 'text_mm5778hh',   // "Mobile Number for Texts"
...
export async function createDeliverySubmissionItem(order, fields) {
  ...
  const writes = [
    ...
    [DELIVERY_COLS.commMethods, Array.isArray(fields.commMethods) ? fields.commMethods.join(', ') : (fields.commMethods || '')],
    [DELIVERY_COLS.mobileForText, fields.mobilePhone || ''],
