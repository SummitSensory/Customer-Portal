...
function parseOrderItem(item) {
  ...
  return {
    ...
    // Billing Information tab — Bill-To Address pulled from Monday
    billingAddressOnFile: getMirror('billingAddressOnFile'),
    billingZipOnFile: getMirror('billingZipOnFile'),
