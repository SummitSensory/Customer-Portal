...
export const COLS = {
  ...
  colorSlide:           process.env.MONDAY_COL_COLOR_SLIDE           || 'color_mm7cj96b', // "Slide-Color" (plastic — no catalog sourced yet; gate exists, not shown to customers)
  ...
  colorFoundationMat:   process.env.MONDAY_COL_COLOR_FOUNDATION_MAT  || 'color_mm7c5nq2', // "Foundation System-Mat Color" (vinyl — no catalog sourced yet; gate exists, not shown to customers)
};
